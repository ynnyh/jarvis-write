...
| 诉求 | 对应设计 | 文档 |
|---|---|---|
| ① 一致性，上下文连得起来 | 长程一致性引擎（三支柱） | [03](03-core-engines.md#一长程一致性引擎) |
| ② 随时改大纲 + 级联更新 | 大纲级联更新引擎 | [03](03-core-engines.md#二大纲级联更新引擎) |
| ③ 文笔润色 | 润色引擎（锁情节改文笔） | [03](03-core-engines.md#三润色引擎) |
| ④ 标签化倾向选择 | 倾向系统（chips + 自定义 + 预设） | [03](03-core-engines.md#四倾向系统) |
