...
6. 凭空常驻角色(cast):对照【已登场角色名册】,本章是否冒出一个被写成「一直都在/每天伺候
   饮食起居/素来相熟/府里的老人」却不在名册、前文也从未出场的常驻角色?尤其与「人少/空荡/
   只有某几人/没有外人」的设定冲突时。注意:以「初次登场/新来/头一回见」方式引入的新人物不
   算矛盾——只揪那种「假装早已存在、素来熟络」的凭空常驻角色。
