...
8. 人物画像贴合(persona):对照【人物画像】,本章台词与行事是否明显违背角色的性格底色
   与说话方式(如「话少而贵」的角色突然话痨煽情、「狠辣果决」的角色遇敌拖泥带水)?是否
   触碰了「绝不做」的底线禁忌?**触碰底线禁忌报 blocker**;底色轻微偏离但可解释的最多 minor,
   不要拿「人物成长」当违规——弧光方向上的合理变化不算矛盾。
